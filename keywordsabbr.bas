...
1170 A$(J)=LEFT$(A$(J),LEN(A$(J))-1)+CHR$(ASC(MID$(A$(J),LEN(A$(J)),1))+128)
1174 REM 128 SHOULD BE 32 FOR ASCII
1180 PRINT MID$(STR$(10*J),2)" ";
1182 IF ASC(RIGHT$(A$(J),1))<128 THEN PRINT A$(J);:GOTO 1186
1184 PRINT LEFT$(A$(J),LEN(A$(J))-1)CHR$(ASC(RIGHT$(A$(J),1))-96);
1186 PRINT ":REM "K$(J)
1190 NEXT
1194 DIM K%(M)
1200 CLS:COLOR 15:PRINT "cOMMANDER x16 basic V2 aBBREVIATIONS:":COLOR 13
1204 FOR J=1 TO M:IF LEN(K$(J))=1 GOTO 1208
1206 PRINT A$(J)"="K$(J),:IF K$(J)="GO" THEN COLOR 1
1208 NEXT
1210 COLOR 14:PRINT "q TO qUIZ"
1220 GET K$:IF K$<>"" THEN IF (ASC(K$) AND $1F)=17 GOTO 1224
1222 GOTO 1220
...
1430 I=I+1:RETURN
1500 REM Shuffling
1510 FOR I=M TO 2 STEP -1
1520 J=INT(I*RND(1))+1:T=K%(I):K%(I)=K%(J):K%(J)=T
1530 NEXT
1540 RETURN
