001 REM SHOW PETSCII TABLE SHIFTED & UNSHIFTED ON X16
010 GOTO 370
020 REM MODULO
...
350 RETURN
360 REM MAIN LOOP
370 IF PEEK($D9)<>40 THEN SYS$FF5F:PRINT
380 GOSUB 210
